      ...
      <div className="w-full h-full flex-center">
        <div className="container relative w-full h-full">
          <div className="md:mt-40 mt-20">
            <p className="font md:text-2xl text-base"> Hey, I&apos;m</p>
            <h1 className="font-bold md:text-9xl text-5xl">
              Aakash V
            </h1>
            <h1 className="font-bold md:text-9xl text-5xl">Menon</h1>
          </div>
          <div className="absolute w-full z-30 bottom-20 right-0">
            <div className="flex justify-between items-end">
              ...
              <div className="flex flex-col items-end">
                ...
                <h1 className="font-bold md:text-9xl text-5xl">XR DEVELOPER</h1>
              </div>
            </div>
          </div>
        </div>
