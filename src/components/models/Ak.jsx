...
Command: npx gltfjsx@6.5.3 ak.glb -T 
Files: ak.glb [835.21KB] > D:\3D-React-Portfolio-main\public\models\ak-transformed.glb [415.46KB] (50%)
*/
...
export function Ak(props) {
  ...
  const { scene } = useGLTF("/models/ak-transformed.glb");
...
useGLTF.preload("/models/ak-transformed.glb")
