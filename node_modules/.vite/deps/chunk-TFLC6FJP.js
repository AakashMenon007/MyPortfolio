...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React4 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is2, useState4 = React4.useState, useEffect4 = React4.useEffect, useLayoutEffect3 = React4.useLayoutEffect, useDebugValue2 = React4.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React4 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is2, useSyncExternalStore = shim.useSyncExternalStore, useRef4 = React4.useRef, useEffect4 = React4.useEffect, useMemo4 = React4.useMemo, useDebugValue2 = React4.useDebugValue;
  ...
  const fiber = React.useMemo(() => {
    for (const maybeFiber of [root, root == null ? void 0 : root.alternate]) {
      ...
      const fiber2 = traverseFiber(maybeFiber, false, (node) => {
        let state2 = node.memoizedState;
        while (state2) {
          if (state2.memoizedState === id)
            return true;
          state2 = state2.next;
        }
      });
...
var useIsomorphicLayoutEffect2 = ((_window$document, _window$navigator) => typeof window !== "undefined" && (((_window$document = window.document) == null ? void 0 : _window$document.createElement) || ((_window$navigator = window.navigator) == null ? void 0 : _window$navigator.product) === "ReactNative"))() ? React2.useLayoutEffect : React2.useEffect;
...
function useBridge() {
  ...
  return React2.useMemo(() => ({
    ...
    const strict = !!traverseFiber(fiber, true, (node) => node.type === React2.StrictMode);
...
function createPointerEvents(store) {
  ...
  return {
    ...
    compute(event, state2, previous) {
      state2.pointer.set((event.offsetX - state2.size.left) / state2.size.width * 2 - 1, -((event.offsetY - state2.size.top) / state2.size.height) * 2 + 1);
...
react-reconciler/cjs/react-reconciler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-TFLC6FJP.js.map
